...
class ForsythEdwardsParserTest: XCTestCase {
    func testForsythEdwardsParse() {
        ...
        if let board = ForsythEdwardsParser.parseBoard("rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2") {
            XCTAssertNil(board.pieceAtSquare(Square("e2")))
            XCTAssertNil(board.pieceAtSquare(Square("c7")))
            XCTAssertNil(board.pieceAtSquare(Square("g1")))

            if let e4 = board.pieceAtSquare(Square("e4")) {
            ...
            if let c5 = board.pieceAtSquare(Square("c5")) {
            ...
            if let f3 = board.pieceAtSquare(Square("f3")) {
